...
export const CHOICES: PeriodChoice[] = [
  {
    ...
    collections: [
      new PeriodCollection("O91", "O91", [
        ...
        new Period(2, 8, 15, 65, SUBJECTS.MATH, "A311"),
        new Period(2, 9, 25, 110, SUBJECTS.ART, "A302"),
        new Period(2, 11, 20, 65, SUBJECTS.SWEDISH, "A308"),
        new Period(2, 13, 15, 50, SUBJECTS.SOCIAL_STUDIES, "A309"),
        new Period(3, 9, 30, 50, SUBJECTS.MATH, "A311"),
        new Period(3, 10, 25, 50, SUBJECTS.SWEDISH, "A308"),
        new Period(3, 11, 30, 50, SUBJECTS.SCIENCE, "A417"),
        new Period(3, 13, 5, 50, SUBJECTS.ENGLISH, "A307"),
        new Period(4, 13, 0, 100, SUBJECTS.ENGINEERING, "A417"),
        new Period(4, 14, 45, 60, SUBJECTS.MATH, "A311"),
      ]),
      new PeriodCollection("O92", "O92", [
        new Period(0, 8, 30, 55, SUBJECTS.SCIENCE, "A417"),
        ...
        new Period(2, 9, 30, 100, SUBJECTS.ENGINEERING, "A417"),
        new Period(2, 11, 20, 65, SUBJECTS.MATH, "A307"),
        new Period(2, 13, 10, 70, SUBJECTS.SWEDISH, "A308"),
        new Period(3, 8, 30, 50, SUBJECTS.MATH, "A311"),
        new Period(3, 9, 30, 110, SUBJECTS.ART, "A302"),
        new Period(3, 11, 25, 65, SUBJECTS.SWEDISH, "A308"),
        new Period(3, 13, 5, 50, SUBJECTS.MATH, "A311"),
      ...
      new PeriodCollection("O93", "O93", [
        ...
        new Period(2, 8, 20, 55, SUBJECTS.SCIENCE, "A417"),
        ...
        new Period(3, 9, 35, 100, SUBJECTS.ENGINEERING, "A417"),
        new Period(3, 11, 25, 55, SUBJECTS.MATH, "A311"),
        new Period(3, 13, 5, 50, SUBJECTS.SOCIAL_STUDIES, "A309"),
        new Period(4, 13, 0, 110, SUBJECTS.ART, "A302"),
        new Period(4, 14, 55, 50, SUBJECTS.SCIENCE, "A417"),
      ]),
    ],
  }, {
    label: "Elevens val",
    ...
    collections: [
      ...
      new PeriodCollection("JZH", "JZH", [
        new Period(4, 9, 30, 50, SUBJECTS.RANDOM, "A417"),
      ]),
